    ...
    <div className="flex flex-col items-center justify-center min-h-[85dvh] px-4 py-16 text-center">
      <div className="space-y-6 max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
          <Link href="/login">
            <Button size="lg" className="glow-pink w-full sm:w-auto">Start predicting ✨</Button>
          </Link>
        </div>
      </div>
      ...
      <div className="mt-10 glass-card rounded-2xl p-6 max-w-sm w-full text-left">
        ...
        <ul className="space-y-2 text-sm text-purple-300">
          <li className="flex items-center gap-2"><span className="text-green-400 font-bold">+1</span> Contestant in your top 10 makes the real top 10</li>
          <li className="flex items-center gap-2"><span className="text-yellow-400 font-bold">+2</span> Bonus for exact rank match</li>
          <li className="flex items-center gap-2"><span className="text-pink-400 font-bold">30</span> Maximum possible score</li>
        </ul>
      </div>
    </div>
  )
